...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String DEFAULT_SUCCESS_URL = "/guest"; 
	...
	protected void configure(HttpSecurity http) throws Exception {
	  ...
	  http.authorizeRequests()
		...
		.antMatchers("/guest/**").access("hasAnyRole('ROLE_GUEST', 'ROLE_USER')")
		.antMatchers("/registration/**").access("hasAnyRole('ROLE_GUEST', 'ROLE_USER')")
		.and()
			.formLogin()
				.loginPage("/login")
